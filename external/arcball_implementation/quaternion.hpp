...
double constexpr pi_divided_by_360 = std::numbers::pi / 360.0; //ADDED THIS LINE

namespace math {

class quaternion {
 public:
  enum class PART { W = 0, X, Y, Z };
